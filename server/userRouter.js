...
router.post("/insertPlant", async (req, res) => {
  try {
    const plant = new Plants({
      ...
      sowInstruction: req.body.sowInstruction,
      spaceInstruction: req.body.spaceInstruction,
      harvestInstruction: req.body.harvestInstruction,
      compatiblePlants: req.body.compatiblePlants,
      avoidInstructions: req.body.avoidInstructions,
      culinaryHints: req.body.culinaryHints,
      culinaryPreservation: req.body.culinaryPreservation,
    });

    var data = await plant.save();
    res.json(data);
  } catch (err) {
